...
const CustomLayout = () => {
  return (
    <>
      <h2 className="text-4xl font-bold text-center font-poppins text-[#37B7C3] mt-[53px] 2xl:mb-[-87px] xl:mb-[-101px] xl:ml-[186px]">About Us</h2>
      <div className="2xl:w-[1768px] xl:w-[1402] bg-white p-8 md:p-16 flex flex-col md:flex-row gap-4">
        {/* Left Column - Images */}
        <div className="w-[589px] flex gap-4 ml-[94px]">
          {/* Main Large Image */}
