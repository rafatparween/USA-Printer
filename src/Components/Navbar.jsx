...
export default function Navbar() {
  return (
    <header>
      {/* Top Bar */}
      <div className="bg-[#F05A22] py-1 px-8 flex justify-between items-center">
      ...
      <div className="flex justify-between items-center px-8 py-4 border-b">
        ...
        <div className="flex items-center">
          ...
          <div>
            ...
            <h2 className="text-orange-500 text-base font-medium">Solutions</h2>
          </div>
        </div>

        {/* Navigation Links */}
        <nav className="flex space-x-8 text-black text-base font-medium">
